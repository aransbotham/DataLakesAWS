...
StepTrainerLanding_node1709482603255 = glueContext.create_dynamic_frame.from_catalog(
    database="stedi",
    table_name="step_trainer_landing",
    transformation_ctx="StepTrainerLanding_node1709482603255",
)

# Script generated for node Fetch Correct Serial Numbers
SqlQuery1 = """
select 
distinct 
at.user as email,
stl.serialNumber
from at 
join stl ON at.timestamp = stl.sensorReadingTime
"""
FetchCorrectSerialNumbers_node1709482644276 = sparkSqlQuery(
    glueContext,
    query=SqlQuery1,
    mapping={
        "at": AccelerometerTrusted_node1709480712591,
        "stl": StepTrainerLanding_node1709482603255,
    },
    transformation_ctx="FetchCorrectSerialNumbers_node1709482644276",
)
...
select distinct
ct.*,
serial.serialNumber as corrected_serialNumber
from ct 
JOIN serial 
ON ct.email = serial.email
"""
KeepCustomerswithAccelerometerData_node1709424633360 = sparkSqlQuery(
    ...
    mapping={
        ...
        "serial": FetchCorrectSerialNumbers_node1709482644276,
    },
